...
module CU(
  ...
  output [2:0]  io_ctrl_wb_sel,
                ...
                io_ctrl_bru_op,
                io_ctrl_csr_calc,
  output [1:0]  io_ctrl_csr_op1_sel,
  output [11:0] io_ctrl_csr_csr_i,
  output [1:0]  io_ctrl_bus_arbit,
  output [31:0] io_imm,
  ...
  wire        _GEN_50 = io_inst == 32'h73;
  wire        _GEN_51 =
    io_inst == 32'h30200073 | io_inst == 32'h10200073 | io_inst == 32'h200073;
    ...
    _GEN_51
      ...
      : _GEN_50
          ...
          : _GEN_39
              ...
              : _GEN_38
                  ? 3'h4
                  : _GEN_37 | _GEN_36 | _GEN_35 | _GEN_34 | _GEN_33 | _GEN_32
                      ? 3'h2
                      : 3'h1;
    ...
    _GEN_51
      ...
      : _GEN_50
          ...
          : _GEN_49
              ...
              : _GEN_48
                  ? 3'h2
                  : _GEN_47 ? 3'h1 : _GEN_45 ? 3'h3 : _GEN_44 ? 3'h2 : {2'h0, _GEN_43};
  ...
  assign io_ctrl_bus_arbit = _GEN_8 ? 2'h2 : 2'h1;
  assign io_imm =
    _GEN_49
      ? {27'h0, io_inst[19:15]}
      : _GEN_48
...
module CSRU(
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin
      ...
      automatic logic _GEN_5 = _GEN_3 & ~_GEN_0 & _GEN_1;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic _GEN_8 = io_csr_i == 12'h342;
      automatic logic _GEN_9;
      automatic logic _GEN_10;
      _GEN_7 = io_csr_i == 12'h300;
      _GEN_9 = _GEN_7 | ~_GEN_8;
      _GEN_10 = _GEN_7 | _GEN_8 | io_csr_i != 12'h341;
      if (_GEN) begin
        if (_GEN_7)
          mstatus <= mstatus & 32'hFFFFFFF7 | io_op1 & 32'h8;
        if (_GEN_9) begin
        end
        else
          mcause <= io_op1;
        ...
        if (_GEN_7)
          mstatus <= mstatus & 32'hFFFFFFF7 | _GEN_11 & 32'h8;
        if (_GEN_9) begin
        end
        else
          mcause <= _GEN_11;
        ...
        if (_GEN_1 & _GEN_7)
          mstatus <= mstatus & 32'hFFFFFFF7 | _GEN_12 & 32'h8;
        if (_GEN_1) begin
          if (_GEN_9) begin
          end
          else
      ...
      ? (_GEN
           ...
           : _GEN_0
               ...
               : _GEN_1
                   ...
                   : _GEN_6 | io_calc != 3'h5 ? 32'h0 : mepc)
      : 32'h0;
endmodule
...
module CPUCore(
  ...
  wire [31:0]      _mem__io_bus_addr;
  wire [3:0]       _mem__io_bus_wen;
  wire [31:0]      _mem__io_bus_wdata;
  ...
  wire [3:0][31:0] _GEN = {{32'h0}, {_mem__io_bus_addr}, {32'h1078}, {32'h0}};
  wire             _GEN_0 =
    _cu__io_ctrl_bus_arbit == 2'h0 | _cu__io_ctrl_bus_arbit == 2'h1
    | _cu__io_ctrl_bus_arbit != 2'h2;
  wire             _GEN_1 = _cu__io_ctrl_wb_sel == 3'h0;
  wire             _GEN_2 = _cu__io_ctrl_wb_sel == 3'h1;
  wire             _GEN_3 = _cu__io_rf_rd_i == 5'h0;
  wire             _GEN_4 = _cu__io_ctrl_wb_sel == 3'h2;
  wire             _GEN_5 = _cu__io_ctrl_wb_sel == 3'h3;
  ...
  CU cu_ (
    ...
    .io_ctrl_bus_arbit   (_cu__io_ctrl_bus_arbit),
    .io_imm              (_cu__io_imm),
  ...
  _rf_32x32 _rf_ext (
    ...
    .W0_en   (~(_GEN_1 | _GEN_2 | _GEN_4 | _GEN_5) & _cu__io_ctrl_wb_sel == 3'h4),
    .W0_clk  (clock),
    .W0_data (_GEN_3 ? 32'h0 : _if__io_out_pc_4),
    .W1_addr (_cu__io_rf_rd_i),
    .W1_en   (~(_GEN_1 | _GEN_2 | _GEN_4) & _GEN_5),
    .W1_clk  (clock),
    .W1_data (_GEN_3 ? 32'h0 : _mem__io_rdata),
    .W2_addr (_cu__io_rf_rd_i),
    .W2_en   (~(_GEN_1 | _GEN_2) & _GEN_4),
    .W2_clk  (clock),
    .W2_data (_GEN_3 ? 32'h0 : _csru__io_out),
    .W3_addr (_cu__io_rf_rd_i),
    .W3_en   (~_GEN_1 & _GEN_2),
    .W3_clk  (clock),
    .W3_data (_GEN_3 ? 32'h0 : _alu__io_out)
  );
  ALU alu_ (
    .io_op1_v
  ...
  MemU mem_ (
    ...
    .io_bus_addr  (_mem__io_bus_addr),
    .io_bus_rdata (io_bus_rdata),
    .io_bus_wen   (_mem__io_bus_wen),
    .io_bus_wdata (_mem__io_bus_wdata),
    .io_rdata     (_mem__io_rdata)
  );
  assign io_bus_addr = _GEN[_cu__io_ctrl_bus_arbit];
  assign io_bus_wen = _GEN_0 ? 4'h0 : _mem__io_bus_wen;
  assign io_bus_wdata = _GEN_0 ? 32'h0 : _mem__io_bus_wdata;
...
module Bridge(
  ...
  assign io_dev_0_wen = {2'h0, io_cpu_wen[1:0] & {2{io_cpu_addr < 32'h1000}}};
...
module miniRV_SoC(
  ...
  DRAM dram (
    .clk (fpga_clk),
    .a   ({2'h0, _bridge_io_dev_0_addr[15:2]}),
